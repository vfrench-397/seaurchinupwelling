...
#treatment (at pvalue 0.003) has a significant impact on gene differential expression 
adonis(pca$x ~ treat, data = pca_s, method='eu', na.rm = TRUE)
```

Heatmap for top 100 most significant differentially expressed genes
...
results=gomwuPlot(input,goAnnotations,goDivision.BP,
	absValue=0.001,  #absolute value set at 0.001 so all non-zero genes are displayed as good genes, standard GO enrichment.
